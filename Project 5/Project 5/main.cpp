...
//        "mad", "deranged", "NEFARIOUS", "half-witted", "robot", "plot", "have"
//    };
//    char test2w2[TEST2_NRULES][MAX_WORD_LENGTH+1] = {
//        "scientist", "robot", "PLOT", "assistant", "deranged", "Nefarious", "mad"
//    };
//    int test2dist[TEST2_NRULES] = {
//        1, 3, 0, 2, 1, 0, 12
//    };
//
//    cout << makeProper(test2w1, test2w2, test2dist, TEST2_NRULES) << endl;
//    printCStringArray(test2w1, TEST2_NRULES);
//    printCStringArray(test2w2, TEST2_NRULES);
//    printArray(test2dist, TEST2_NRULES);
//
...
//        "scientist", "police", "scientist", "scientist"
//    };
//    int test3dist[TEST1_NRULES] = {
//        1, 3, 0, 12
//    };
//
//    cout << makeProper(test3w1, test3w2, test3dist, TEST3_NRULES) << endl;
//    printCStringArray(test3w1, TEST3_NRULES);
//    printCStringArray(test3w2, TEST3_NRULES);
//    printArray(test3dist, TEST3_NRULES);
//
//    const int TEST4_NRULES = 6;
//    char test4w1[TEST4_NRULES][MAX_WORD_LENGTH+1] = {
//        "m-ad", "Mad", "mad", "friend", "mad", "pas-"
//    };
//    char test4w2[TEST4_NRULES][MAX_WORD_LENGTH+1] = {
//        "sCIENTIST", "pOlice", "ScIEntist", "friend", "scientist", "mania"
//    };
//    int test4dist[TEST4_NRULES] = {
//        1, 3, 0, 12, 5, 6
//    };
//
//    cout << makeProper(test4w1, test4w2, test4dist, TEST3_NRULES) << endl;
//    printCStringArray(test4w1, TEST4_NRULES);
//    printCStringArray(test4w2, TEST4_NRULES);
//    printArray(test4dist, TEST4_NRULES);
//    int r=  makeProper(test4w1, test4w2, test4dist, TEST3_NRULES);
//    printCStringArray(test4w1, r);
//    printCStringArray(test4w2, r);
//    printArray(test4dist, r);
//
...
//    //    char test2w1[][MAX_WORD_LENGTH+1] = {
    //        "scientist","half-deranged", "nefar5ous", "almost-have"
    //    };
    ...
    //    };
    //
    //    printCStringArray(test2w1, 4);
    //    printCStringArray(test2w2, 4);
    //    printArray(test2dist, 4);
    //    int r=  makeProper(test2w1, test2w2, test2dist, 4);
    //    printCStringArray(test2w1, r);
    //    printCStringArray(test2w2, r);
    //    printArray(test2dist, r);
//
...
//               1, 3, 0, -12, 5
//           };
//    //cout << (makeProper(test9w1, test9w2, test9dist, 5));
////    printCStringArray(test9w1, 5);
////    printCStringArray(test9w2, 5);
////    printArray(test9dist, 5);
////    r=  makeProper(test9w1, test9w2, test9dist, 5);
////    printCStringArray(test9w1, r);
////    printCStringArray(test9w2, r);
////    printArray(test9dist, r);
//
//        assert(makeProper(test9w1, test9w2, test9dist, 5) == 2); //checks to see if it removes empty string properly (in both w1 and w2)
//           assert(makeProper(test9w1, test9w2, test9dist, -4) == 0);// checks for negative nPatterns passed in
